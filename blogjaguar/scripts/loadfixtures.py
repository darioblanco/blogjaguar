...
BLOGPOST_TITLES = [
    "Nullam euismod lacinia ultrices. Integer.",
    "Ut sapien ante, volutpat sit amet posuere consequat",
    "Ut eget quam vitae velit ornare adipiscing.",
    "Cras erat sapien, faucibus blandit mattis a, dignissim eget metus.",
    "Nunc sagittis velit tortor."
]
BLOGPOST_CONTENTS = [
...
if __name__ == '__main__':
    os.environ['DJANGO_SETTINGS_MODULE'] = 'blogjaguar.settings'
