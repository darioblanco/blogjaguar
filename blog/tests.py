...
from darioblog.blog.models import Entry, Link, Category



#class ContentTest(TestCase):
#
#    def test_adding_dummy_categories(self):
#        print "\n Testing categories creation"
#        d = DummyCreator()
#        d.create_categories()
#
#    def test_adding_dummy_entries(self):
#        print "\n Testing entries creation"
#        d = DummyCreator()
#        d.create_entries(1000)
#
#    def test_adding_dummy_links(self):
#        print "\n Testing links creation"
#        d = DummyCreator()
#        d.create_links()
...
class DummyCreator():
    ...
    def __create_category(self, lang, title, desc):
        ...
        cat.save()
        print("Created category : "+lang+" | "+title+" | "+desc+" | ")
    ...
    def __create_entry(self, lang, author, cat, title, post, date):
        ...
        print("Created entry : "+lang+" | "+title)
    ...
    def create_entries(self, num_entries):
        ...
        for i in range(num_entries) :
            ...
            print "Category: "+str(cat_id)+" | Loren: "+str(loren_id)+" | Title: "+str(title_id)
